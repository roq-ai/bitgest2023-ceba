...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'database_connection.create': {
    roles: ['administrator', 'database-manager'],
    key: 'database-connected',
    tenantPath: ['company', 'database_connection'],
    userPath: [],
  },
  'customer.create': {
    roles: ['administrator', 'database-manager'],
    key: 'data-inserted',
    tenantPath: ['company', 'customer'],
    userPath: [],
  },
  'customer.delete': {
    roles: ['administrator', 'database-manager'],
...
const tenantRoles: string[] = ['administrator', 'database-manager'];
