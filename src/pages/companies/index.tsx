...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'customer.count', 'database_connection.count', 'form.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('customer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('database_connection', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'database_connection',
          header: 'Database Connection',
          accessorKey: 'database_connection',
          cell: ({ row: { original: record } }: any) => record?._count?.database_connection,
        }
      : null,
