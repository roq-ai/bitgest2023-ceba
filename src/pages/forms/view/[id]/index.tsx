            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('form', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/forms/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Form Type" text={data?.form_type} />
                ...
                {hasAccess('table_structure', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/table-structures/view/${data?.table_structure?.id}`}>
                        {data?.table_structure?.table_name}
                      </Link>
                    }
                  />
                )}
